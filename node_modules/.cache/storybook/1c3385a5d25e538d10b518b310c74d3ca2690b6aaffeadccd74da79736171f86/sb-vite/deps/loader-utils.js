...
var require_isUrlRequest = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_urlToRequest = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_wasm_hash = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var MAX_SHORT_STRING = Math.floor(65472 / 4) & -4;
	var WasmHash = class {
		/**
		...
		*/
		_updateWithShortString(data, encoding) {
			const { exports: exports$2, buffered, mem, chunkSize } = this;
			let endPos;
		...
		*/
		_updateWithBuffer(data) {
			const { exports: exports$3, buffered, mem } = this;
		...
		digest(type) {
			const { exports: exports$4, buffered, mem, digestSize } = this;
			exports$4.final(buffered);
...
var require_interpolateName = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function interpolateName(loaderContext, name, options = {}) {
		...
		if (loaderContext.resourcePath) {
			...
			else folder = path.basename(directory);
		}
