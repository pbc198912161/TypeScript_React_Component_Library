	...
	(function(global, factory) {
		...
		pp$8.parseExport = function(node, exports$5) {
			...
			if (this.shouldParseExportStatement()) {
				...
				if (node.declaration.type === "VariableDeclaration") this.checkVariableExport(exports$5, node.declaration.declarations);
				else this.checkExport(exports$5, node.declaration.id, node.declaration.id.start);
				node.specifiers = [];
				node.source = null;
		...
		pp$8.checkPatternExport = function(exports$7, pat) {
			...
			else if (type === "Property") this.checkPatternExport(exports$7, pat.value);
			else if (type === "AssignmentPattern") this.checkPatternExport(exports$7, pat.left);
			else if (type === "RestElement") this.checkPatternExport(exports$7, pat.argument);
		};
...
//#endregion
//#region node_modules/acorn-jsx/index.js
