...
import { t as require_preview_api } from "./preview-api-Dq6vfVHp.js";
import { t as require_dist } from "./jsdoc-type-pratt-parser.js";
//#endregion
//#region node_modules/@storybook/core/dist/docs-tools/index.js
var import_preview_errors = (/* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var he = /* @__PURE__ */ o((e) => e.name === "literal", "isLiteral"), be = /* @__PURE__ */ o((e) => e.value.replace(/['|"]/g, ""), "toEnumOption"), Pe = /* @__PURE__ */ o((e) => {
	...
	switch (typeof r < "u" && (n.raw = r), e.name) {
		...
		case "union": return e.elements?.every(he) ? {
			...n,
			name: "enum",
...
var at = /* @__PURE__ */ o((e, t, r) => {
	...
	return w(ue(e, { name: "unknown" }, t), r);
}, "unknownFactory"), I = /* @__PURE__ */ o((e) => {
	switch (e) {
		case "JavaScript": return at;
		case "TypeScript": return ct;
		case "Flow": return lt;
		default: return ut;
	}
}, "getPropDefFactory");
var me = /* @__PURE__ */ o((e) => e.type != null ? "JavaScript" : e.flowType != null ? "Flow" : e.tsType != null ? "TypeScript" : "Unknown", "getTypeSystem"), mt = /* @__PURE__ */ o((e) => {
	let t = me(e[0]), r = I(t);
	return e.map((n) => {
		let s = n;
...
//#endregion
export { je as a, oe as c, z as d, gt as i, on as l, Y as n, l as o, cn as r, nn as s, B as t, yn as u };

//# sourceMappingURL=docs-tools-YQ0ye_dN.js.map